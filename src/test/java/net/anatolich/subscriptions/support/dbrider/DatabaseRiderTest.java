...
/**
 * Annotate database-rider based test with this annotation to avoid issues with the flyway.
 * Database-rider cleans data from all the tables (if requested), including the flyway metadata table.
 * That makes flyway to try to perform already made migrations.
 *
